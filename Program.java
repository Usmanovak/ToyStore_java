...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = true;
        System.out.println("Розыгрыш начинается!");
        while (flag){
            System.out.println("Выберите один из следующих пунктов: 1.Добавить игрушки для розыгрыша; 2.Показать все имеющиеся игрушки; 3.Сменить шанс выпадения для игрушки; 4.Разыграть приз; 5.Принять приз; 6.Получить талон для выдачи приза; 7.Выйти");
            try{
            if(scanner.hasNext()) {
                ...
                switch (key) {
                    ...
                    case 3:
                        try {
                            System.out.println("Tребуется ввести имя игрушки и шанс через пробел");
                ...
                System.out.println("Ты ввёл буквы вместо цифр. Попробуй еще раз");
            }
        }
